...
@onready var player_camera = get_tree().current_scene.get_node("Chapter 1/CharacterBody2D/Camera2D")
@onready var platforming_player = get_tree().current_scene.get_node("Chapter 1/CharacterBody2D")
...
func change_room(room_position: Vector2, room_size: Vector2) -> void:
	print("Changing room to position: ", room_position, " with size: ", room_size)
